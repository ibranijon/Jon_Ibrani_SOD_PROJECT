...
---
Ensure the `Dataset` folder is located in the same root directory as the project files for proper path resolution. `Dataset` with its subfolders (`Image`,`Mask`)should be inside the CNN Project folder together with the other python files.
